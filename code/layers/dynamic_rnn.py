...
class DynamicLSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers=1, bias=True, batch_first=True, dropout=0.3,
                 bidirectional=True, only_use_last_hidden_state=False, rnn_type = 'GRU'):
        """
